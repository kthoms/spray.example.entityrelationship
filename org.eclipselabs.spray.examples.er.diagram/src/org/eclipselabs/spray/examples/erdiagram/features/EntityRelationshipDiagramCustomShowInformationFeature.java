/*************************************************************************************
 *
 * Generated on Thu Jun 27 08:34:05 CEST 2013 by Spray CustomFeature.xtend
 * 
 * This file is an extension point: copy to "src" folder to manually add code to this
 * extension point.
 *
 *************************************************************************************/
package org.eclipselabs.spray.examples.erdiagram.features;
...
public class EntityRelationshipDiagramCustomShowInformationFeature extends EntityRelationshipDiagramCustomShowInformationFeatureBase {
    ...
    public void execute(final ICustomContext context, final EObject object) {
    	MessageDialog.openInformation(Display.getDefault().getActiveShell(),
    			 "Information",
    			                "Selected object is of type "+object.eClass().getName());    }
